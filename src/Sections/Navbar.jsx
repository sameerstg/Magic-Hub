...
function Navbar() {
  ...
  return (
    //max-w-[1240px]
    <ul className="navbar h-100 desktop:h-52  text-white mx-auto laptop:max-w-[1300px] w-full">
      ...
      <div className="flex justify-between px-10 items-center desktop:hidden">
        ...
        <div className="">
            {showMenu?null:<img className="h-20 mt-6" src={logo} alt="" />}
          
        </div>
        {showMenu?null:<div className="mobile-menu">
...
//             <div className='flex  desktop:justify-around items-center '>
//                 <div className='flex laptop:px-14 ' >
...
//                         <li className='buynow-button px-5 desktop:px-12 laptop:py-3 tablet:px-3 '>Buy Now</li>
//                     </div>
//                 </div>
