...
function Section4() {
    return (
        <div className='text-white   w-full mx-auto pt-0 mobile:pt-16 mobile:mb-20 laptop:mb-0 tablet:pt-0 '>
            <div className='grid w-full desktop:grid-cols-2 grid-cols-1'>
                <img className='mx-auto px-10 tablet:px-6' src={chart} alt="" />
                <div className='desktop:px-11 px-0 w-3/4 mx-auto'>
                    <div className='text-6xl font-bold py-5'>Token Allocation</div>
                    <div className='font-medium pb-2'>The MHUB token distribution strategy is designed to ensure the project's longevity and
